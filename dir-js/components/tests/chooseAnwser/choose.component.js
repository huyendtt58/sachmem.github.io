...
var ChooseComponent = (function () {
    function ChooseComponent(dataService) {
        ...
        this.title = 'Test English online';
    }
    ...
    ChooseComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof choose_service_1.DataService !== 'undefined' && choose_service_1.DataService) === 'function' && _a) || Object])
    ], ChooseComponent);
